...
// @ts-ignore
import { ProviderPropType, Animated as AnimatedMap, AnimatedRegion, Marker, } from 'react-native-maps';

import PanController from './PanController';
import AnimatedPriceMarker from './AnimatedPriceMarker';
...
class AnimatedViewMap extends React.Component {
  ...
  componentDidMount() {
    const { region, panX, panY, scrollX, markers }: any = this.state;
...
export default AnimatedViewMap;
