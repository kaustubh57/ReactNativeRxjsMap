...
class Callout3Map extends React.Component {
  private marker1: any;
  private marker2: any;
  private marker4: any;
  private map: any;
  ...
  render() {
    const {region, markers, cnt}: any = this.state;
    return (
...
// @ts-ignore
Callout3Map.propTypes = {
  provider: ProviderPropType,
};

export default Callout3Map;
